...
def send_to_personal():
    ...
    #root.configure(title="Whatsapp Message Sent To Contact")
...
generate_send_to_personal_button = Button(root, text="Send_Psnl", command=send_to_personal, width = 7) 
...
generate_send_to_group_button = Button(root, text="Send_Grp", command=send_to_group, width = 7) 
...
# Label for Content
cntnt_label = Label(root, text="Content", width = 10)
...
generate_send_mail_button = Button(root, text="Send Mail",command=mail, width = 7)
